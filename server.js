...
const clienteRoutes = require('./src/routes/cliente_rout');//
const etapaRoutes = require('./src/routes/etapa_rout');//
const proyectoRoutes = require('./src/routes/proyecto_rout');//
const tipoProyectoRoutes = require('./src/routes/tipoProyecto_rout');//
const universidadRoutes = require('./src/routes/universidad_rout');//
